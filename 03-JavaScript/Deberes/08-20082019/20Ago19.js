/*Deberes JS para el 20 Agosto 2019
...
/*Given the following array, create a second array that filters out all the food that has meat 
and outputs the sentence seen below

// Tip: You can chain map and filter to first remove the elements you don't want in your new array 
...
const filterBooks = booksList.filter(function(book){
...
Define a function "compose" that receives two functions and a number as arguments and applies the composiion of
